  ...
  try {
    ...
    return (
      <main className="mx-auto max-w-3xl px-6 py-24">
        <Link href="/#wins" className="text-sm text-helm-accent hover:underline">
          ← Back to briefing
        </Link>
    ...
    <main className="pb-16">
      {w.image_url ? (
        <div className="relative h-64 w-full md:h-80">
          ...
          <div className="absolute inset-x-0 bottom-0 mx-auto max-w-5xl px-6 pb-8">
            <p className="text-xs uppercase tracking-[0.25em] text-helm-sand/80">Win report</p>
      ...
      <div className="mx-auto max-w-5xl px-6 py-10">
        ...
        <div className="mt-4 flex flex-wrap items-center gap-2">
          <span className="pill bg-helm-ocean/20 text-helm-accent">{w.category}</span>
        ...
        <p className="mt-4 font-display text-xl text-helm-sand">{w.headline}</p>

        <div className="mt-6 rounded-2xl border border-helm-sky/20 bg-helm-sky/10 p-5">
        ...
        <section className="mt-8 grid gap-3 sm:grid-cols-3">
          {w.metrics.map((m, i) => (
            <div key={i} className="card-win p-4">
              ...
              <p className="mt-1 font-display text-2xl font-semibold text-helm-good">{m.value}</p>
        ...
        <section className="mt-8 rounded-2xl border border-helm-gold/25 bg-helm-gold/10 p-5">
          <p className="text-[11px] font-medium uppercase tracking-[0.18em] text-helm-gold">
