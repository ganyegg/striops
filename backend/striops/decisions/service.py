...
win it addressed, with a review-by date that Striops can flag when it lapses.
"""
...
def build_decision_register(code: str = "CPT") -> DecisionRegister:
    ...
    return DecisionRegister(
        ...
        note=(
            ...
            "risk or win it addresses. Striops flags what lapses; nothing depends on memory."
        ),
    )
