...
_SPINE: list[dict] = [
    {
        ...
        "ownership_note": (
            ...
            "linked externally; Striops will not invent hospital stats."
        ),
    ...
    },
    {
        ...
        "metrics": [],
        "blocker_if_empty": "Publish monthly delivery vs budgeted units into Striops.",
    },
    {
        "id": "energy",
        "name": "Energy",
...
def build_sectors_report(municipality: str = "CPT") -> SectorsReport:
    ...
    for defn in _SPINE:
        ...
        if affected is None and present:
            from striops.demographics import lookup_affected
