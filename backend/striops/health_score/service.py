...
from striops.core.models import Opportunity, Risk
...
def build_health_breakdown(municipality: str = "CPT") -> HealthBreakdown:
    ...
    narrative = None
    try:
        from striops.core.cache import cache_get
        from striops.core.config import get_settings

        settings = get_settings()
        cached = cache_get(f"brief:{settings.striops_municipality}", settings.striops_brief_ttl_seconds)
